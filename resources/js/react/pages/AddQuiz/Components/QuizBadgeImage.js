...
const QuizBadgeImage = ({ image, setImage, error }) => {
    ...
    return (
        <Box marginTop={2}>
            <FormLabel htmlFor="quiz_badge_image" fontWeight="bold">
                <Flex alignItems="center">
                    <Text>Base Badge Image</Text>
                    {image ? null : (
                        <Image
                            marginLeft={2}
                            src={uploadLogo}
